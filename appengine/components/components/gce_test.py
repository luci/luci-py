...
class GceTest(test_case.TestCase):
  ...
  def test_get_instance(self):
    ...
    self.assertEqual(
      instance("inst_id"), gce.Project("123").get_instance("zone-id", "inst_id")
    )
                  ...
                  "errors": [
                    {
                      "domain": "global",
                      "reason": "invalid",
                      "message": "Invalid value for field 'zone': 'z3'. Unknown zone.",
                    }
                  ],
                  "code": 400,
                  "message": "Invalid value for field 'zone': 'z3'. Unknown zone.",
  ...
  def test_get_network_interfaces(self):
    ...
    self.assertEqual(
      expected_interfaces_int, gce.get_network_interfaces("project", "", False)
    )

  def test_get_zone_url(self):
    self.assertEqual(
      "https://www.googleapis.com/compute/v1/projects/123/zones/us-central1-a",
      gce.get_zone_url("123", "us-central1-a"),
    )
  ...
  def test_get_region_url(self):
    self.assertEqual(
      "https://www.googleapis.com/compute/v1/projects/123/regions/us-central1",
      gce.get_region_url("123", "us-central1"),
    )
