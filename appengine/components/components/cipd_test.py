...
class Test(unittest.TestCase):
  ...
  def test_is_valid_instance_id(self):
    ...
    self.assertTrue(
      cipd.is_valid_instance_id("b-AF8UbArxfy_4EXYaa8vAxTncdMtMIorleb_Wg303UC")
    )
    self.assertFalse(
      cipd.is_valid_instance_id("bAF8UbArxfy_UEXYaa8vAxTncdMtMIorleb_Wg30UC==")
    )
    self.assertFalse(
      cipd.is_valid_instance_id("b-AF8UbArxfy/4EXYaa8vAxTncdMtMIorleb_Wg303UC")
    )
