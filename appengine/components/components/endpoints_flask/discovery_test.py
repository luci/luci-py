...
class DiscoveryWebapp2TestCase(test_case.TestCase):
  ...
  def test_get_parameters(self):
    ...
    self.assertEqual(
      discovery._get_parameters(
        Message, "path/{boolean}/with/{string}/parameters"
      ),
      expected,
    )
  ...
  def test_directory(self):
      ...
      "items": [
        {
          ...
          "discoveryRestUrl": "http://localhost:8080/api/discovery/v1/apis/service/v1/rest",
          "documentationLink": "link",
          "icons": {
            "x16": "https://www.google.com/images/icons/product/search-16.gif",
            "x32": "https://www.google.com/images/icons/product/search-32.gif",
        ...
        },
        {
          ...
          "discoveryRestUrl": "http://localhost:8080/api/discovery/v1/apis/split/v1/rest",
          "icons": {
            "x16": "https://www.google.com/images/icons/product/search-16.gif",
            "x32": "https://www.google.com/images/icons/product/search-32.gif",
          },
    ...
    self.assertEqual(
      discovery.directory(
        [Service, ServiceA, ServiceB], "localhost:8080", "/api"
      ),
      expected,
    )
