...
_AUTHDB = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='token_server_url', full_name='components.auth.proto.replication.AuthDB.token_server_url', index=7,
