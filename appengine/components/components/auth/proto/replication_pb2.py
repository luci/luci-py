...
_AUTHIPWHITELISTASSIGNMENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='created_by', full_name='components.auth.proto.replication.AuthIPWhitelistAssignment.created_by', index=3,
      number=4, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='created_ts', full_name='components.auth.proto.replication.AuthIPWhitelistAssignment.created_ts', index=4,
