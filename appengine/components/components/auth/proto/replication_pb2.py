...
_AUTHDB = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ip_whitelists', full_name='components.auth.proto.replication.AuthDB.ip_whitelists', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ip_whitelist_assignments', full_name='components.auth.proto.replication.AuthDB.ip_whitelist_assignments', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='token_server_url', full_name='components.auth.proto.replication.AuthDB.token_server_url', index=6,
