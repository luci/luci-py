...
class SignatureTest(test_case.TestCase):
  def test_get_service_account_certificates(self):
    ...
    self.assertEqual(
      certs.to_jsonish()["certificates"],
      [
        {
          "key_name": "cba74246d54580c5ee7a6a778c997a7cb1abc918",
          "x509_certificate_pem": "def",
        },
        {
          "key_name": "faffca3b64d5bb61da829ace9aed119dceb2f63c",
          "x509_certificate_pem": "abc",
        },
      ],
    )
