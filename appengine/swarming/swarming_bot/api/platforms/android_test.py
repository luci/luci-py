...
class TestGetDimensions(unittest.TestCase):
    ...
    return self.mock_android_device(
      {
        ...
        "ro.build.fingerprint": (
          "NVIDIA/darcy/darcy:7.0/NRD90M/1915764_848.4973:user/release-keys"
        ),
        "ro.build.id": ("NRD90M"),
    ...
    return self.mock_android_device(
      {
        ...
        "ro.build.fingerprint": (
          "google/bullhead/bullhead:6.0.1/MMB29Q/2480792:userdebug/dev-keys"
        ),
        "ro.build.id": ("MMB29Q"),
    ...
    return self.mock_android_device(
      {
        ...
        "ro.board.platform": ("msm8992"),
        "ro.build.fingerprint": (
          "google/bullhead/bullhead:8.0.0/"
      ...
      "mock_nexus5x_oreo",
      {GMS_PACKAGE: "10.9.32", PLAYSTORE_PACKAGE: "7.9.66.Q-all"},
    )
  ...
  def get_mock_pixel2(self):
    return self.mock_android_device(
      ...
      "mock_pixel2",
      {GMS_PACKAGE: "11.5.80", PLAYSTORE_PACKAGE: "8.0.62.R-all"},
    )
    ...
    return self.mock_android_device(
      {
        "ro.product.brand": ("google"),
        "ro.build.fingerprint": (
          "google/taimen/taimen:9/PPR1.180610.009/4898911:userdebug/dev-keys"
        ),
    ...
    return self.mock_android_device(
      {
        "ro.product.brand": ("google"),
        "ro.build.fingerprint": (
          "google/oriole/oriole:14/AP1A.240405.002/11480754:userdebug/dev-keys"
        ),
      ...
      "mock_pixel6",
      {GMS_PACKAGE: "23.45.24", PLAYSTORE_PACKAGE: "38.8.31-29"},
    )
    ...
    return self.mock_android_device(
      {
        ...
        "ro.build.fingerprint": (
          "samsung/zerofltetmo/zerofltetmo:7.0/"
  ...
  def get_mock_android_trunk(self):
    return self.mock_android_device(
      ...
      "mock_wembley",
      {GMS_PACKAGE: "22.26.15", PLAYSTORE_PACKAGE: "1.2.3"},
    )
  ...
  def test_wembley_get_dimensions(self):
    ...
    self.assertEqual(
      wembley_result, android.get_dimensions([self.get_mock_android_trunk()])
    )
