...
NEEDED_PROTOS = {
  ...
  "buildbucket/proto/backend_pb2.py",
  "buildbucket/proto/backend_prpc_pb2.py",
  "buildbucket/proto/task_pb2.py",
  "buildbucket/proto/build_pb2.py",
  "buildbucket/proto/step_pb2.py",
  ...
  "resultdb/proto/v1/invocation_pb2.py",
  "resultdb/proto/v1/common_pb2.py",
  "resultdb/proto/v1/predicate_pb2.py",
...
def add_bb_prefix_to_import(file_path):
  ...
  for line in contents:
    if "from go.chromium.org.luci" in line:
      line = line.replace(
        "from go.chromium.org.luci", "from bb.go.chromium.org.luci"
      )
      was_modified = True
...
def main():
  ...
  for sub in SUB_PATHS:
    ...
    with open(sub_dir + "/README.md", "w") as rmd:
      print(
        "// Generated by update_taskbackend_protos.py. DO NOT EDIT.", file=rmd
      )
