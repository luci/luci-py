...
_FETCHTASKSRESPONSE_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='buildbucket.v2.FetchTasksResponse.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='task', full_name='buildbucket.v2.FetchTasksResponse.Response.task', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='error', full_name='buildbucket.v2.FetchTasksResponse.Response.error', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='response', full_name='buildbucket.v2.FetchTasksResponse.Response.response',
...
_FETCHTASKSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='responses', full_name='buildbucket.v2.FetchTasksResponse.responses', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_FETCHTASKSRESPONSE_RESPONSE, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_FETCHTASKSRESPONSE_RESPONSE.fields_by_name['task'].message_type = go_dot_chromium_dot_org_dot_luci_dot_buildbucket_dot_proto_dot_task__pb2._TASK
_FETCHTASKSRESPONSE_RESPONSE.fields_by_name['error'].message_type = google_dot_rpc_dot_status__pb2._STATUS
_FETCHTASKSRESPONSE_RESPONSE.containing_type = _FETCHTASKSRESPONSE
_FETCHTASKSRESPONSE_RESPONSE.oneofs_by_name['response'].fields.append(
  _FETCHTASKSRESPONSE_RESPONSE.fields_by_name['task'])
_FETCHTASKSRESPONSE_RESPONSE.fields_by_name['task'].containing_oneof = _FETCHTASKSRESPONSE_RESPONSE.oneofs_by_name['response']
_FETCHTASKSRESPONSE_RESPONSE.oneofs_by_name['response'].fields.append(
  _FETCHTASKSRESPONSE_RESPONSE.fields_by_name['error'])
_FETCHTASKSRESPONSE_RESPONSE.fields_by_name['error'].containing_oneof = _FETCHTASKSRESPONSE_RESPONSE.oneofs_by_name['response']
_FETCHTASKSRESPONSE.fields_by_name['responses'].message_type = _FETCHTASKSRESPONSE_RESPONSE
...
FetchTasksResponse = _reflection.GeneratedProtocolMessageType('FetchTasksResponse', (_message.Message,), {
  ...
  'Response' : _reflection.GeneratedProtocolMessageType('Response', (_message.Message,), {
    'DESCRIPTOR' : _FETCHTASKSRESPONSE_RESPONSE,
    '__module__' : 'go.chromium.org.luci.buildbucket.proto.backend_pb2'
    # @@protoc_insertion_point(class_scope:buildbucket.v2.FetchTasksResponse.Response)
    })
  ,
...
_sym_db.RegisterMessage(FetchTasksResponse.Response)
...
_TASKBACKENDLITE = _descriptor.ServiceDescriptor(
  name='TaskBackendLite',
  full_name='buildbucket.v2.TaskBackendLite',
  file=DESCRIPTOR,
  index=1,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='RunTask',
    full_name='buildbucket.v2.TaskBackendLite.RunTask',
    index=0,
    containing_service=None,
    input_type=_RUNTASKREQUEST,
    output_type=_RUNTASKRESPONSE,
...
_sym_db.RegisterServiceDescriptor(_TASKBACKENDLITE)

DESCRIPTOR.services_by_name['TaskBackendLite'] = _TASKBACKENDLITE
