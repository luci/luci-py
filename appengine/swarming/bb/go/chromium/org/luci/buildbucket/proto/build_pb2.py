...
_BUILD_OUTPUT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='status', full_name='buildbucket.v2.Build.Output.status', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='status_details', full_name='buildbucket.v2.Build.Output.status_details', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='summary_html', full_name='buildbucket.v2.Build.Output.summary_html', index=5,
...
_BUILD_BUILDERINFO = _descriptor.Descriptor(
  name='BuilderInfo',
  full_name='buildbucket.v2.Build.BuilderInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='description', full_name='buildbucket.v2.Build.BuilderInfo.description', index=0,
...
_BUILD = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='builder_info', full_name='buildbucket.v2.Build.builder_info', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='number', full_name='buildbucket.v2.Build.number', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='created_by', full_name='buildbucket.v2.Build.created_by', index=4,
  ...
  nested_types=[_BUILD_INPUT, _BUILD_OUTPUT, _BUILD_BUILDERINFO, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_BUILDINFRA_BUILDBUCKET_AGENT_INPUT_CIPDSOURCEENTRY = _descriptor.Descriptor(
  name='CipdSourceEntry',
  full_name='buildbucket.v2.BuildInfra.Buildbucket.Agent.Input.CipdSourceEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='buildbucket.v2.BuildInfra.Buildbucket.Agent.Input.CipdSourceEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='buildbucket.v2.BuildInfra.Buildbucket.Agent.Input.CipdSourceEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BUILDINFRA_BUILDBUCKET_AGENT_INPUT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='cipd_source', full_name='buildbucket.v2.BuildInfra.Buildbucket.Agent.Input.cipd_source', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_BUILDINFRA_BUILDBUCKET_AGENT_INPUT_DATAENTRY, _BUILDINFRA_BUILDBUCKET_AGENT_INPUT_CIPDSOURCEENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_BUILDINFRA_BUILDBUCKET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='build_number', full_name='buildbucket.v2.BuildInfra.Buildbucket.build_number', index=8,
...
_BUILDINFRA_RESULTDB = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\340A\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='enable', full_name='buildbucket.v2.BuildInfra.ResultDB.enable', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='bq_exports', full_name='buildbucket.v2.BuildInfra.ResultDB.bq_exports', index=3,
      number=4, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='history_options', full_name='buildbucket.v2.BuildInfra.ResultDB.history_options', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BUILDINFRA_BACKEND = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='caches', full_name='buildbucket.v2.BuildInfra.Backend.caches', index=2,
      number=3, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='task_dimensions', full_name='buildbucket.v2.BuildInfra.Backend.task_dimensions', index=3,
      number=5, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='hostname', full_name='buildbucket.v2.BuildInfra.Backend.hostname', index=4,
...
_BUILD_OUTPUT.fields_by_name['status'].enum_type = go_dot_chromium_dot_org_dot_luci_dot_buildbucket_dot_proto_dot_common__pb2._STATUS
_BUILD_OUTPUT.fields_by_name['status_details'].message_type = go_dot_chromium_dot_org_dot_luci_dot_buildbucket_dot_proto_dot_common__pb2._STATUSDETAILS
_BUILD_OUTPUT.containing_type = _BUILD
_BUILD_BUILDERINFO.containing_type = _BUILD
...
_BUILD.fields_by_name['builder_info'].message_type = _BUILD_BUILDERINFO
...
_BUILD.fields_by_name['retriable'].enum_type = go_dot_chromium_dot_org_dot_luci_dot_buildbucket_dot_proto_dot_common__pb2._TRINARY
...
_BUILDINFRA_BUILDBUCKET_AGENT_INPUT_CIPDSOURCEENTRY.fields_by_name['value'].message_type = _INPUTDATAREF
_BUILDINFRA_BUILDBUCKET_AGENT_INPUT_CIPDSOURCEENTRY.containing_type = _BUILDINFRA_BUILDBUCKET_AGENT_INPUT
_BUILDINFRA_BUILDBUCKET_AGENT_INPUT.fields_by_name['data'].message_type = _BUILDINFRA_BUILDBUCKET_AGENT_INPUT_DATAENTRY
_BUILDINFRA_BUILDBUCKET_AGENT_INPUT.fields_by_name['cipd_source'].message_type = _BUILDINFRA_BUILDBUCKET_AGENT_INPUT_CIPDSOURCEENTRY
...
_BUILDINFRA_BACKEND.fields_by_name['caches'].message_type = go_dot_chromium_dot_org_dot_luci_dot_buildbucket_dot_proto_dot_common__pb2._CACHEENTRY
_BUILDINFRA_BACKEND.fields_by_name['task_dimensions'].message_type = go_dot_chromium_dot_org_dot_luci_dot_buildbucket_dot_proto_dot_common__pb2._REQUESTEDDIMENSION
...
Build = _reflection.GeneratedProtocolMessageType('Build', (_message.Message,), {
  ...
  'BuilderInfo' : _reflection.GeneratedProtocolMessageType('BuilderInfo', (_message.Message,), {
    'DESCRIPTOR' : _BUILD_BUILDERINFO,
    '__module__' : 'go.chromium.org.luci.buildbucket.proto.build_pb2'
    # @@protoc_insertion_point(class_scope:buildbucket.v2.Build.BuilderInfo)
    })
  ,
  'DESCRIPTOR' : _BUILD,
  '__module__' : 'go.chromium.org.luci.buildbucket.proto.build_pb2'
...
_sym_db.RegisterMessage(Build.BuilderInfo)
  ...
  'Buildbucket' : _reflection.GeneratedProtocolMessageType('Buildbucket', (_message.Message,), {
    ...
    'Agent' : _reflection.GeneratedProtocolMessageType('Agent', (_message.Message,), {
      ...
      'Input' : _reflection.GeneratedProtocolMessageType('Input', (_message.Message,), {
        ...
        'CipdSourceEntry' : _reflection.GeneratedProtocolMessageType('CipdSourceEntry', (_message.Message,), {
          'DESCRIPTOR' : _BUILDINFRA_BUILDBUCKET_AGENT_INPUT_CIPDSOURCEENTRY,
          '__module__' : 'go.chromium.org.luci.buildbucket.proto.build_pb2'
          # @@protoc_insertion_point(class_scope:buildbucket.v2.BuildInfra.Buildbucket.Agent.Input.CipdSourceEntry)
          })
        ,
...
_sym_db.RegisterMessage(BuildInfra.Buildbucket.Agent.Input.CipdSourceEntry)
...
_BUILD.fields_by_name['cancellation_markdown']._options = None
