...
class BotServicePrpcTest(PrpcTest):
  ...
  def test_bot_get(self):
    ...
    request = swarming_pb2.BotRequest(
      bot_id="bot1",
    )
  ...
  def test_get_ok_realm(self, api):
    ...
    resp = self.post_prpc(
      api, swarming_pb2.BotRequest(bot_id="id1"), expect_errors=True
    )
    self.assertEqual(resp.status, "403 Forbidden")
  ...
  def test_delete_ok(self):
    ...
    # is it gone?
    resp = self.post_prpc(
      "DeleteBot", swarming_pb2.BotRequest(bot_id="id1"), expect_errors=True
    )
    self.assertEqual(resp.status, "404 Not Found")
  ...
  def test_events(self):
    ...
    self.assertEqual({"must_stop": False, "ok": True}, resp)
  ...
  def test_list_ok(self):
    ...
    def _verify(
      ...
      if dimensions is None:
        dimensions = []
      request = swarming_pb2.BotsRequest(
        limit=100,
  ...
  def test_count_ok(self):
    ...
    def _verify(
      dimensions, count=0, quarantined=0, maintenance=0, dead=0, busy=0
    ):
    ...
    _verify(
      dimensions=[], count=4, quarantined=2, maintenance=1, dead=0, busy=4
    )
    self.assertEqual(1, bot_management.cron_update_bot_info())
    _verify(
      dimensions=[], count=4, quarantined=2, maintenance=1, dead=1, busy=4
    )
    _verify(
      dimensions=[
        swarming_pb2.StringPair(key="pool", value="default"),
  ...
  def test_forbidden_realm(self, rpc, request):
    ...
    self.assertEqual(resp.status, "403 Forbidden")
    expected = cgi.escape(
      "No such pool or no permission to use it: unknown", quote=True
    )
    self.assertEqual(expected, response.body)
...
class TaskServicePrpcTest(PrpcTest):
  ...
  def test_result_long(self):
    ...
    resp = self.post_prpc(
      "GetResult",
      swarming_pb2.TaskIdWithPerfRequest(task_id="12310" * 10),
      expect_errors=True,
    )
    self.assertEqual(resp.status, "400 Bad Request")
  ...
  def test_result_completed_task(self):
    ...
    response = self.post_prpc(
      "GetResult",
      swarming_pb2.TaskIdWithPerfRequest(
        task_id=task_id, include_performance_stats=True
      ),
    )
  ...
  def test_request_ok(self):
    ...
    response = self.post_prpc(
      "GetRequest", swarming_pb2.TaskIdRequest(task_id=task_id)
    )
  ...
  def test_cancel_pending(self):
    ...
    response = self.post_prpc(
      "GetResult",
      swarming_pb2.TaskIdWithPerfRequest(
        task_id=task_id, include_performance_stats=False
      ),
    )
    actual = swarming_pb2.TaskResultResponse()
    _decode(response.body, actual)
  ...
  def test_cancel_with_realm_permission(self):
    ...
    self.post_prpc(
      ...
      swarming_pb2.TaskCancelRequest(
        task_id=task_id_with_realm, kill_running=False
      ),
    )
    self.post_prpc(
      "CancelTask",
      swarming_pb2.TaskCancelRequest(
        task_id=task_id_without_realm, kill_running=False
      ),
    )
  ...
  def test_cancel_running(self):
    ...
    response = self.post_prpc(
      "CancelTask",
      swarming_pb2.TaskCancelRequest(task_id=task_id, kill_running=True),
      expect_errors=True,
    )
    actual = swarming_pb2.CancelResponse()
    _decode(response.body, actual)
  ...
  def test_cancel_with_too_long_key(self):
    ...
    resp = self.post_prpc(
      "CancelTask",
      swarming_pb2.TaskCancelRequest(task_id="12310" * 10, kill_running=False),
      expect_errors=True,
    )
    self.assertEqual(resp.status, "400 Bad Request")
  ...
  def test_stdout_ok(self):
    ...
    expected = swarming_pb2.TaskOutputResponse(
      output="rÉsult string".encode("utf-8"),
      state=swarming_pb2.TaskState.COMPLETED,
    )
    for i in (task_id, run_id):
      response = self.post_prpc(
        "GetStdout", swarming_pb2.TaskIdWithOffsetRequest(task_id=i)
      )
    ...
    response = self.post_prpc(
      "GetStdout",
      swarming_pb2.TaskIdWithOffsetRequest(task_id=task_id, offset=1, length=2),
    )
    actual = swarming_pb2.TaskOutputResponse()
    _decode(response.body, actual)
    # This is because it's counting in bytes, not in unicode characters:
    expected = swarming_pb2.TaskOutputResponse(
      output="É".encode("utf-8"), state=swarming_pb2.TaskState.COMPLETED
    )
    self.assertEqual(expected, actual)

    response = self.post_prpc(
      "GetStdout",
      swarming_pb2.TaskIdWithOffsetRequest(task_id=task_id, offset=3, length=5),
    )
    actual = swarming_pb2.TaskOutputResponse()
    _decode(response.body, actual)
    expected = swarming_pb2.TaskOutputResponse(
      output="sult ".encode("utf-8"), state=swarming_pb2.TaskState.COMPLETED
    )
    self.assertEqual(expected, actual)
  ...
  def test_new_ok(self):
    ...
    actual = swarming_pb2.TaskRequestMetadataResponse()
    _decode(response.body, actual)
    self.assertEqual("5cee488008810", actual.task_id)
  ...
  def test_new_task_performance_stats_are_empty(self):
    ...
    response = self.post_prpc(
      "GetResult",
      swarming_pb2.TaskIdWithPerfRequest(
        task_id=actual.task_id, include_performance_stats=True
      ),
    )
    actual = swarming_pb2.TaskResultResponse()
    _decode(response.body, actual)
  ...
  def test_new_ok_in_realms_mode(self):
    ...
    ntr.properties.command.extend(["echo", "hi"])
  ...
  def test_new_invalid_realm(self):
    ...
    expected = (
      "Bad realm u'test/invalid', want &quot;&lt;project&gt;:&lt;name&gt;&quot;"
    )
  ...
  def test_new_ok_with_resultdb_and_realm(self):
    ...
    with mock.patch(
      ...
      ntr = self._new_task_request_prpc()
      ntr.ClearField("expiration_secs")
      task_slice = swarming_pb2.TaskSlice(
        expiration_secs=180, wait_for_capacity=True
      )
  ...
  def test_mass_cancel_pending(self):
    ...
    tcr = swarming_pb2.TasksCancelRequest(
      limit=100,
      tags=["project:yay"],
      start=message_conversion_prpc.date(
        self.now - datetime.timedelta(seconds=1)
      ),
      end=message_conversion_prpc.date(now_120 + datetime.timedelta(seconds=1)),
    )
  ...
  def test_mass_cancel_realm_permission(self):
    ...
    self.assertEqual(resp.status, "403 Forbidden")
    self.assertEqual("No pool is specified", resp.body)
  ...
  def _gen_two_tasks(self):
    ...
    return (
      ...
      second,
      now_120,
      message_conversion_prpc.date(start),
      message_conversion_prpc.date(end),
    )
  ...
  def test_list_request(self):
    ...
    def _verify(
      ...
      request = swarming_pb2.TasksRequest(
        limit=10, state=state, sort=sort, tags=tags
      )
      request.start.FromDatetime(start)
      request.end.FromDatetime(end)
  ...
  def test_list_task_states_ok(self):
    ...
    expected = swarming_pb2.TaskStates(
      states=[swarming_pb2.CANCELED, swarming_pb2.PENDING, swarming_pb2.PENDING]
    )
    self.assertEqual(expected, actual)
  ...
  def test_list_task_states_invalid(self):
    ...
    self.assertEqual(response.status, "400 Bad Request")
    expected_error = cgi.escape(
      "Invalid task_id: Invalid key u'invali'", quote=True
    )
  ...
  def test_batch_get_result(self):
    ...
    self.set_as_user()
    self.mock_auth_db(
      [auth.Permission("swarming.tasks.get")], task_realm="test:visible"
    )
    ...
    self.assertEqual(
      ...
      [
        ...
        (invisible_pending_id, "No access to see the status of this task"),
        (invisible_canceled_id, "No access to see the status of this task"),
        (
          run_result_id,
...
class SwarmingServicePrpcTest(PrpcTest):
  ...
  def test_public_permissions(self):
    ...
    response = self.post_prpc(
      "GetPermissions", swarming_pb2.PermissionsRequest()
    )
    _decode(response.body, actual)
    self.assertEqual(expected, actual)
  ...
  def test_user_permissions_with_bot_id(self):
    ...
    actual = swarming_pb2.ClientPermissions()
    response = self.post_prpc(
      "GetPermissions", swarming_pb2.PermissionsRequest(bot_id="bot1")
    )
    _decode(response.body, actual)
    self.assertEqual(expected, actual)
  ...
  def test_user_permissions_with_task_id(self):
    ...
    actual = swarming_pb2.ClientPermissions()
    response = self.post_prpc(
      "GetPermissions", swarming_pb2.PermissionsRequest(task_id=task_id)
    )
    _decode(response.body, actual)
    self.assertEqual(expected, actual)
  ...
  def test_user_permissions_with_pool_tags(self):
    ...
    actual = swarming_pb2.ClientPermissions()
    response = self.post_prpc(
      "GetPermissions", swarming_pb2.PermissionsRequest(tags=["pool:default"])
    )
    _decode(response.body, actual)
    self.assertEqual(expected, actual)
