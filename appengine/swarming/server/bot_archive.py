...
FILES = (
  ...
  "third_party/httplib2/auth.py",
  "third_party/httplib2/cacerts.txt",
  "third_party/httplib2/certs.py",
  "third_party/httplib2/error.py",
  "third_party/httplib2/httplib_auth.py",
  ...
  "third_party/pyparsing/__init__.py",
...
def yield_swarming_bot_files(
  ...
  items["config/config.json"] = _make_config_json(
    host, host_version, settings
  ).encode()
