...
class ConfigBundleRev(ndb.Model):
  ...
  stable_bot = ndb.StructuredProperty(
    BotArchiveInfo, indexed=False, name="StableBot"
  )
  canary_bot = ndb.StructuredProperty(
    BotArchiveInfo, indexed=False, name="CanaryBot"
  )
