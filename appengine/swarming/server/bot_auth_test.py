...
class BotAuthTest(test_case.TestCase):
  ...
  def test_ip_whitelist_based_auth_ok(self):
    ...
    self.assertEquals({"pool": ["with_ip_whitelist"]}, group_cfg.dimensions)
  ...
  def test_machine_token_ok(self):
    ...
    self.assertEquals({"pool": ["with_token"]}, group_cfg.dimensions)
  ...
  def test_machine_token_ip_whitelist_ok(self):
    ...
    self.assertEquals(
      {"pool": ["with_token_and_ip_whitelist"]}, group_cfg.dimensions
    )
    self.assertTrue(auth_cfg.require_luci_machine_token)
    self.assertEquals("ip_whitelist", auth_cfg.ip_whitelist)
  ...
  def test_service_account_ok(self):
    ...
    self.assertEquals({"pool": ["with_service_account"]}, group_cfg.dimensions)
  ...
  def test_service_account_ip_whitelist_ok(self):
    ...
    self.assertEquals(
      {"pool": ["with_service_account_and_ip_whitelist"]}, group_cfg.dimensions
    )
    self.assertTrue(auth_cfg.require_service_account)
    self.assertEquals("ip_whitelist", auth_cfg.ip_whitelist)
  ...
  def test_gce_token_ok(self):
    ...
    self.assertEquals({"pool": ["bot_with_gce_token"]}, group_cfg.dimensions)
    self.assertEquals(
      bot_groups_config.BotAuthGCE(project="expected_proj"),
  ...
  def test_containerized_bot_id(self):
    ...
    self.assertEquals({"pool": ["container1"]}, group_cfg.dimensions)
    group_cfg, _ = bot_auth.authenticate_bot("bot_host--container2")
    self.assertEquals({"pool": ["container2"]}, group_cfg.dimensions)
    group_cfg, _ = bot_auth.authenticate_bot("bot_host--container3")
    self.assertEquals({"pool": ["container_range"]}, group_cfg.dimensions)
    group_cfg, _ = bot_auth.authenticate_bot("bot_host--container99")
    self.assertEquals({"pool": ["bot_host"]}, group_cfg.dimensions)
  ...
  def test_first_method_is_used(self):
    ...
    self.assertEquals(
      {"pool": ["with_fallback_to_ip_wl"]}, group_cfg.dimensions
    )
    self.assertTrue(auth_cfg.require_luci_machine_token)
