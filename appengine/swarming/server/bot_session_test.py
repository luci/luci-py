...
EXPECTED_BOT_CONFIG = session_pb2.BotConfig(
  expiry={"seconds": 1262405045, "nanos": 6000},
  debug_info={
    "created": {"seconds": 1262401445, "nanos": 6000},
  ...
  bot_auth=[
    ...
    {"require_gce_vm_token": {"project": "gce-proj"}, "log_if_failed": True},
    {"ip_whitelist": "ip-allowlist"},
  ],
  system_service_account="system@example.com",
  logs_cloud_project="logs-cloud-project",
...
class BotSessionTest(test_case.TestCase):
  ...
  def test_create(self):
    ...
    self.assertEqual(
      ...
      session_pb2.Session(
        ...
        handshake_config_hash=bot_session._handshake_config_hash(TEST_CONFIG),
      ),
    )
  ...
  def test_update(self):
    ...
    bot_session.update(
      session, TEST_CONFIG, "rbe", "pool:dut_id:dut_123", "dut_id"
    )
    bot_config = EXPECTED_BOT_CONFIG
