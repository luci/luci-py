...
_POOL_RBEMIGRATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='effective_bot_id_dimension', full_name='swarming.config.Pool.RBEMigration.effective_bot_id_dimension', index=3,
...
_POOL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='informational_dimension_re', full_name='swarming.config.Pool.informational_dimension_re', index=12,
...
_EXTERNALSCHEDULERCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='disable_percent', full_name='swarming.config.ExternalSchedulerConfig.disable_percent', index=8,
