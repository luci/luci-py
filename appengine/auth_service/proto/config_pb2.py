...
DelegationConfig = _reflection.GeneratedProtocolMessageType('DelegationConfig', (_message.Message,), dict(
...
_sym_db.RegisterMessage(DelegationConfig)
_sym_db.RegisterMessage(DelegationConfig.Rule)
