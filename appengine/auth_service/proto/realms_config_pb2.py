...
RealmsCfg = _reflection.GeneratedProtocolMessageType('RealmsCfg', (_message.Message,), dict(
...
CustomRole = _reflection.GeneratedProtocolMessageType('CustomRole', (_message.Message,), dict(
