...
def trigger_replication(auth_db_rev=None, transactional=False):
  ...
  # TODO (b/330223725): re-enable once replication task processing in
  # Auth Service v2 (Go) is fixed. Failed tasks throttle the replication
  # task queue for Auth Service v1 (Python).
  #
