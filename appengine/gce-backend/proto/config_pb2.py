...
_INSTANCETEMPLATECONFIG_INSTANCETEMPLATE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='metadata_from_file', full_name='gce_backend.InstanceTemplateConfig.InstanceTemplate.metadata_from_file', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='machine_type', full_name='gce_backend.InstanceTemplateConfig.InstanceTemplate.machine_type', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='network_url', full_name='gce_backend.InstanceTemplateConfig.InstanceTemplate.network_url', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='auto_assign_external_ip', full_name='gce_backend.InstanceTemplateConfig.InstanceTemplate.auto_assign_external_ip', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='min_cpu_platform', full_name='gce_backend.InstanceTemplateConfig.InstanceTemplate.min_cpu_platform', index=13,
